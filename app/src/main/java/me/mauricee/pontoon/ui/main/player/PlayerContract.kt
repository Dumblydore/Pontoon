...
sealed class PlayerAction : EventTracker.Action {
    ...
    data class PlayVideo(val videoId: String, val commentId: String? = null, val initialMode: ViewMode = ViewMode.Expanded) : PlayerAction()
...
sealed class PlayerReducer {
    ...
    data class DisplayVideo(val video: Video, val viewMode: ViewMode) : PlayerReducer()
